...
def scraping(begin_date, end_date, max_num, sleep, directory, verbose):
...
def main():
    ...
    parser.add_argument('--end_date', type=str, default='2019-03-31', help='datetime YYYY-mm-dd')
    parser.add_argument('--directory', type=str, default='./output', help='Output directory')
    parser.add_argument('--max_num', type=int, default=200, help='Maximum number of news to be scraped')
    ...
    scraping(begin_date, end_date, max_num, sleep, directory, VERBOSE)
